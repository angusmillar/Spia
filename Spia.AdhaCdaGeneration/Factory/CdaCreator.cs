...
namespace Spia.AdhaCdaGeneration.Factory
{
  public class CdaCreator
  {
    ...
    public void Process2(Spia.PathologyReportModel.Model.PathologyReport Report, string CdaOutputDirectory, string PdfDirectory, byte[] LogoBytes = null)
    {      
      ...
      cdaContext.Custodian.Participant.Address = GetCdaAddress2(Report.PerformingLaboratory.Address);
      ...
      cdaContext.LegalAuthenticator.Participant.Addresses = new List<IAddress>() { GetCdaAddress2(Report.PerformingLaboratory.Address) };
      ...
      pathologyResultReport.SCSContext.Author.Participant.Addresses = new List<IAddress>
        {
          GetCdaAddress2(Report.PerformingLaboratory.Address)
        };
      ...
      pathologyResultReport.SCSContext.SubjectOfCare.Participant.Person.PersonNames.Add(GetCdaPatientName2(Report.Patient.Name));

      pathologyResultReport.SCSContext.SubjectOfCare.Participant.Person.Gender = GetCdaGender2(Report.Patient.Gender);
      ...
      {
        pathologyResultReport.SCSContext.SubjectOfCare.Participant.Addresses.Add(GetCdaAddress2(Address));
      }
    ...
    public void Process(CdaCreatorInput input)
    {
      ...
      {
        pathologyResultReport.SCSContext.SubjectOfCare.Participant.Person.PersonNames.Add(GetCdaPatientName(this.Input.Message.Segment("PID").Field(5)));
      }
    ...
    private IPersonName GetCdaPatientName2(Spia.PathologyReportModel.Model.Name Name)
    {
    ...
    private Gender GetCdaGender2(Spia.PathologyReportModel.Model.GenderType GenderType)
    {
      switch (GenderType)
      {
    ...
    private IAddress GetCdaAddress2(Spia.PathologyReportModel.Model.Address Address)
    {
