...
namespace Spia.AdhaCdaGeneration.Factory
{
  public class CdaCreator
  {
    ...
    public void Process(CdaCreatorInput input)
    {
      ...
      string TempAttachmentFilePath = System.IO.Path.Combine(TempWorkingDirectoryPath.FullName, "attachment.pdf");
      System.IO.File.Copy(this.Input.FilePathToPdfReport, System.IO.Path.Combine(TempWorkingDirectoryPath.FullName, TempAttachmentFilePath));
      AttachmentPdf.Path = TempAttachmentFilePath;      
