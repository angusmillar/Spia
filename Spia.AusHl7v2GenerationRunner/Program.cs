...
//namespace Spia.AusHl7v2GenerationRunner
//{
//  class Program
//  {
...
//    {
//      Console.WriteLine("Generate SPIA HL7 v2 Messages");
//      string OutputPath = @"C:\temp\SPIAMessages\HL7v2";
//      Console.WriteLine($"Clear the output directory at: {OutputPath}");
...
//      Console.WriteLine($"Generate: {PdfFileName}.hl7");
...
//    {
//      DirectoryInfo OutputDirInfo = new DirectoryInfo(DirectoryPath);
//      foreach (FileInfo file in OutputDirInfo.GetFiles())
//      {
//        file.Delete();
//      }
//    }
